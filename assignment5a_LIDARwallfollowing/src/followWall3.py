...
class VisualCortex:
    def __init__(self):                
        ...
        self.rPlus = radians(45)
        self.rMins = radians(45)
        ...
        while not rospy.is_shutdown():        
            if self.isAlive:
                ...
                if self.scan_front.min() > 0.5:
                    ...
                    self.vel_msg.angular.z = limit(-1.2 * (self.scan_right[self.rMinsIndx] - self.dist_ref)  -0.6 * (self.scan_right[-1] - self.scan_right[1]), -0.2, 0.2)
